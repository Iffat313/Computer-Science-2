...
void print_help() {
    ...
    cout << "  5  Tests the Date operator<< function";
#if !LAB2_TEST5
    cout << " (inactive)";
#endif
    cout << endl;

    cout << "  6  Tests the BlogEntry constructors";
#if !LAB2_TEST6
    cout << " (inactive)";
#endif
    cout << endl;

    cout << "  7  Tests the BlogEntry getters/setters";
#if !LAB2_TEST7
    cout << " (inactive)";
#endif
    cout << endl;

    cout << "  8  Tests the BlogEntry printHTML function";
#if !LAB2_TEST9
    cout << " (inactive)";
#endif
    cout << endl;

    cout << "  9  Tests the Date getDayOfWeek function";
#if !LAB2_TEST9
    cout << " (inactive)";
#endif
    cout << endl;

    cout << " 10  Tests the Date relational operators";
#if !LAB2_TEST10
    cout << " (inactive)";
#endif
    cout << endl;
